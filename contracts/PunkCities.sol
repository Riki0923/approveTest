...
contract PunkCity is ERC1155 {
    ...
    mapping(address => bool) registeredAPlace;
    ...
    function registerPlace(uint256 _placeType, uint256 _questType, string memory _ipfsuri) public isUserRegistered(msg.sender) {
        ...
        registeredAPlace[msg.sender] = true;
    ...
    function checkRegisteredPlace(address _address) public view returns(bool){
        return registeredAPlace[_address];
    }
